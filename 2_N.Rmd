...
load("output/N/n_samples_vB.RData")
load("output/N/ratio_and_components_n_vB.RData")
median(n_extract_vB$theta_sigma/rowMeans(n_extract_vB$sigma))
median(sqrt(ratio))
hist(sqrt((effect_var_mean*mean(trialnr_vB$n))/2), xlim = c(0.19, 0.23))
hist(rowMeans(n_extract_vB$sigma), xlim = c(0.19, 0.23))
hist(rowMeans(n_extract_vB$sigma), xlim = c(0.19, 0.23))
mean(sqrt((effect_var_mean*40)/2))
mean(rowMeans(n_extract_vB$sigma))
# 40 instead of 46.5 trials
